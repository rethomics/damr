...
test_that("Start and stop dates work as expected when reading whole file with error 51 at the begining and end", {
  ...
  expect_silent(damr:::find_dam2_first_last_lines( FILE,
...
test_that("Error when dates are inconsistent", {
  ...
  expect_error(damr:::find_dam2_first_last_lines(FILE, "2017-07-30 14:55:00", "2017-07-01 13:51:00", tz="UTC"),
               regex="start_datetime is greater than stop_datetime")

  # data not present in the file
  expect_error(damr:::find_dam2_first_last_lines(FILE, "2017-01-30 14:55:00", "2017-02-01 13:51:00", tz="UTC"),
               regex="No data")

  # data present in the end, but error 51
  expect_error(damr:::find_dam2_first_last_lines(FILE, "2017-07-03 00:06:00", +Inf, tz="UTC"),
               regex="No data")

  expect_error(damr:::find_dam2_first_last_lines(FILE, -Inf, "2017-06-30 14:42:00", tz="UTC"),
               regex="No data")
